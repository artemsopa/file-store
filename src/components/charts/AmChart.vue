    ...
    methods: {
        ...
        hospitalchart() {
            am4core.ready(function () {
                ...
                const chart = am4core.create('hospital-chart-01', am4charts.XYChart);
        ...
        layout1chart() {
            ...
            // create chart
            const chart = am4core.create('layout-1-chart', am4charts.GaugeChart);
        ...
        socialChart() {
            am4core.ready(function () {
                ...
                // create chart
                const chart = am4core.create('ecommerce-chart-03', am4charts.GaugeChart);
        ...
        lineZoomV() {
            am4core.ready(function () {
                ...
                chart.colors.list = [am4core.color('#37e6b0')];
                // Create category axis
                const categoryAxis = chart.xAxes.push(new am4charts.CategoryAxis());
        ...
        map2() {
            am4core.ready(function () {
                ...
                // Create map instance
                const chart = am4core.create('school-chart-05', am4maps.MapChart);
                // Set map definition
        ...
        map(elem) {
            ...
            (r.useGeodata = !0),
                r.hide(),
                r.geodataSource.events.on('done', function () {
                    // eslint-disable-next-line no-sequences,no-unused-expressions
                    n.hide(), r.show();
                });
