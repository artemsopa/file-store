...
<template>
    <div class="container-fluid">
        ...
        <div v-if="data" class="icon icon-grid i-grid">
            <div class="row">
                <div v-for="(list, index) in files" :key="index" class="col-lg-4 col-md-6 col-sm-6">
